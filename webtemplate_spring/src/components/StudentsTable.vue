<template>
  <div>
    ...
    <v-row>
      <v-col>
        <v-btn @click="addNewRowStart">Add new student</v-btn>
      </v-col>
    </v-row>
    <v-simple-table>
...
import { springGetAll, springDeleteItem, springAddNewItem, springUpdateItem } from "../endpoints/table_students_endpoints";
...
export default {
  ...
  methods: {
    ...
    editRowStart(item) {
      this.title = `Modify existing student #${item.id}`
